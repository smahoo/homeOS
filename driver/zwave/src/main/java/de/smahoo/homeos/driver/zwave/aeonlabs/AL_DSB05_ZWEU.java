...
/***
 * ZWave Device represents the AeonLabs Multisensor 
 * including temperature, humidity, motion and light. 
 * 
 * {@link}http://aeot.ec/spprt/multisensor
 * 
 * @author Mathias Runge  (runge@smahoo.de)
 * 
 *
 */

public class AL_DSB05_ZWEU extends ZWaveDevice implements SensorClimate, SensorMotion{
	...
	public AL_DSB05_ZWEU(String id, JWaveNode node){
		super(id,node);		
