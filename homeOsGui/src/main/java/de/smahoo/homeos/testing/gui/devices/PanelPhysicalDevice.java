...
import de.smahoo.homeos.testing.gui.FrameFunctionExecution;
...
public class PanelPhysicalDevice extends PanelDetails{
	...
	public void onDeviceEvent(DeviceEvent evt){
		...
		case DEVICE_PROPERTY_CHANGED: setProperties();
		}
	}
	...
	private void initGui(){
		...
		listProperties = new JList<DeviceProperty>();
		...
		listFunctions = new JList<PhysicalDeviceFunction>();
	...
	private JList<PhysicalDeviceFunction> listFunctions;
	private JList<DeviceProperty> listProperties;
